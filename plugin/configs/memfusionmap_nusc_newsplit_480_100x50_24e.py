...
pkl_root = '/workspace/jingyus/dataset_pkl/nuscenes/streammapnet'
...
eval_config = dict(
    type='NuscDataset',
    data_root=data_root,
    ann_file=pkl_root+'/nuscenes_map_infos_val_newsplit.pkl',
    meta=meta,
    roi_size=roi_size,
    cat2id=cat2id,
    pipeline=[
...
data = dict(
    ...
    train=dict(
        type='NuscDataset',
        data_root=data_root,
        ann_file=pkl_root+'/nuscenes_map_infos_train_newsplit.pkl',
        meta=meta,
        roi_size=roi_size,
        cat2id=cat2id,
